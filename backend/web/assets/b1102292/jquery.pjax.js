...
function pjax(options) {
  ...
  options.success = function(data, status, xhr) {
    ...
    // This behaviors is incorrect. So if theres no current focus, autofocus
    // the last field.
    //
...
// Install pjax functions on $.pjax to enable pushState behaviors.
//
